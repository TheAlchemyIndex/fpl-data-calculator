...
import GameweekProviderTestSchema.gameweekProviderTestStruct
import GameweekTestSchema.gameweekTestStruct
...
class GameweekProviderTest extends TestHelper {
  ...
  val DROPPED_COLUMNS: Seq[String] = Seq("transfers_balance", "own_goals", "kickoff_time", "red_cards", "team_a_score",
